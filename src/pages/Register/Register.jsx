    ...
    <div className="auth-container register-page">
      <div className="auth-card">
        <div className="auth-card__header">
          ...
          <p className="auth-card__subtitle">Rejoignez Marmitouille pour partager et découvrir des recettes</p>
        </div>
        
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="auth-form__group">
            <label htmlFor="displayName" className="auth-form__label">Nom d'utilisateur</label>
          ...
          <div className="auth-form__group">
            ...
            <p className="auth-form__hint">Le mot de passe doit contenir au moins 8 caractères</p>
          </div>
          

          
          <button type="submit" className="auth-form__submit">Créer un compte</button>
        ...
        <div className="auth-card__footer">
          <p>Déjà inscrit ? <Link to="/login" className="auth-card__link">Se connecter</Link></p>
        </div>
      </div>
